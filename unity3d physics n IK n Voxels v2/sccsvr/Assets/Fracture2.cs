    ...
    void Start()
    {
        ...
        for (int  i = 0; i <FracturingObj.Count;i++)
        {
            ...
            /*Material[] m = new Material[]
            {
                    ...
                    Resources.Load("Material/FracColor2") as Material,
            ...
            */
            if (regenerateNsavemeshtofile == 1)
            {
                ...
                string planeAssetName = FracturingObj[i].gameObject.name + ".asset";
            ...
            //FracturingObj[i].gameObject.AddComponent<SplitMesh>().mat = 
