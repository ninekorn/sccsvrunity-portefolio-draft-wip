...
public class bulletcollision : MonoBehaviour
{
    ...
    int counterForByteChangeMax = 0; //7

    Stopwatch stopwatch = new Stopwatch();

    public int hastarget = -1;
            ...
            //if (buttonPressedLeft || buttonPressedRight)// Input.GetMouseButton(0))
            {
                //if (Physics.Raycast(ray, out hit))
                {
                    if (collision.transform.tag == "collisionObject")
                    {
                        ...
                        if (planetmanager.GetComponent<sccsproceduralplanetbuilderGen2>().getChunkmainChunkGen2((int)collision.transform.position.x, (int)collision.transform.position.y, (int)collision.transform.position.z) != null)
                        {
                            //////Debug.Log("==count==");
                            mainChunk currentChunk = planetmanager.GetComponent<sccsproceduralplanetbuilderGen2>().getChunkmainChunkGen2((int)collision.transform.position.x, (int)collision.transform.position.y, (int)collision.transform.position.z);
                            ...
                            if (collision.contacts[0].normal.x == 0 && collision.contacts[0].normal.y == 0 && collision.contacts[0].normal.z == -1) //FRONT FACE
                            {
                                ...
                                currentChunk.planetchunk.GetComponent<sccsplanetchunkGen2>().SetByte((int)indexX, (int)indexY, (int)indexZ, activeBlockType);
            ...
            if (counterForByteChange == 0)// counterForByteChangeMax)
            {
                if (this.transform.name == "tip")//if (buttonPressedLeft || buttonPressedRight)// Input.GetMouseButton(0))
                {
                    if (Physics.Raycast(ray, out hit, 0.1f))
                    {
                        ...
                        collisionTransform = hit.transform;
                        ...
                        if (hit.transform.tag == "collisionObject")
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    //////Debug.Log("==count==");
                                    mainChunkGen2 currentChunk = planetmanager.GetComponent<sccsproceduralplanetbuilderGen2>().getChunkmainChunkGen2((int)hit.transform.position.x, (int)hit.transform.position.y, (int)hit.transform.position.z);
                                    ...
                                    if (hit.normal.x == 0 && hit.normal.y == 0 && hit.normal.z == -1) //FRONT FACE
                                    {
                                        ...
                                        Vector3 chunkbytepos = new Vector3(x, y, z);
                                        ...
                                        if (x > 1.0f)
                                        {
                                            indexX = Mathf.RoundToInt((((x - Mathf.Floor(x)) * chunkWidth) / chunkWidth) * chunkWidth);
                                        }
                                        else
                                        {
                                        ...
                                        if (y > 1.0f)
                                        {
                                            indexY = Mathf.RoundToInt(((((y - Mathf.Floor(y)) * chunkWidth) / chunkWidth) * chunkWidth));
                                        }
                                        else
                                        {
                                        ...
                                        if (z > 1.0f)
                                        {
                                            indexZ = Mathf.RoundToInt((((z - Mathf.Floor(z)) * chunkWidth) / chunkWidth) * chunkWidth);
                                        }
                                        else
                                        {
                                    ...
                                    else if (hit.normal.x == 1 && hit.normal.y == 0 && hit.normal.z == 0) //RIGHT FACE
                                    {
                                        ...
                                        if (x > 1.0f)
                                        {
                                            indexX = Mathf.RoundToInt((((x - Mathf.Ceil(x)) * chunkWidth) / chunkWidth) * chunkWidth);
                                        }
                                        else
                                        {
                                            indexX = Mathf.RoundToInt((Mathf.Round(x * chunkWidth) / chunkWidth) * chunkWidth);
                                    ...
                                    {
                                        //this.transform.TransformPoint(thepointinquestion);
                                    ...
                                    else if (hit.normal.x == 0 && hit.normal.y == 1 && hit.normal.z == 0) //TOP FACE
                                    {
                                        ...
                                        if (y > 1.0f)
                                        {
                                            indexY = Mathf.RoundToInt(((((y - Mathf.Ceil(y)) * chunkWidth) / chunkWidth) * chunkWidth));
                                        }
                                        else
                                        {
                                            indexY = Mathf.RoundToInt((Mathf.Round(y * chunkWidth) / chunkWidth) * chunkWidth);
