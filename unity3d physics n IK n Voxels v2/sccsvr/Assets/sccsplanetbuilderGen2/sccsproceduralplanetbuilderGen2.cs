...
public class sccsproceduralplanetbuilderGen2 : MonoBehaviour
{
    public struct somemessage
    {
        ...
        public int[] arrayOfDrawSwitchesLock;
        public int[][] arrayOfTriangles;
        public Vector3[][] arrayOfVertices;
    }
    ...
    private void Start()
    {
        ...
        _main_received_messages[0].arrayOfVertices = new Vector3[total][];
        _main_received_messages[0].arrayOfTriangles = new int[total][];
        _main_received_messages[0].arrayOfDrawSwitchesLock = new int[total];

        for (int i = 0; i < total; i++)
        {
            _main_received_messages[0].chunkByteMaps[i] = new int[width * height * depth];
            _main_received_messages[0].arrayOfDrawSwitchesLock[i] = 0;
        }
                                                                        ...
                                                                        if (somemsg[0].somechunkarray[indexmain].map != null)
                                                                        {
                                                                            ...
                                                                            if (indexOfChunkMapByte >= 0 && indexOfChunkMapByte < width * height * depth)//((int)indexx < 0) || ((int)indexy < 0) || ((int)indexz < 0) || ((int)indexy >= width) || ((int)indexx >= height) || ((int)indexz >= depth))
                                                                            {
                                                                                if (somemsg[0].somechunkarray[indexmain].map[indexOfChunkMapByte] == 1)//currentChunk.somesccsplanetchunkFinal.GetByte((int)indexx, (int)indexy, (int)indexz) == 1)
                                                                                {
                                                                                    ...
                                                                                    somemsg[0].somechunkarray[indexmain].sccsSetMap();
                                                                                    somemsg[0].somechunkarray[indexmain].Regenerate();

                                                                                    for (int j = 0; j < width * height * depth; j++)
                                                                                    {
                                                                                        if (somemsg[0].somechunkarray[indexmain].map != null)
                                                                                        {
                                                                                            somemsg[0].somechunkarray[indexmain].CreateChunkFaces();
                                                                                        }
                                                                                    }

                                                                                    somemsg[0].arrayOfVertices[indexmain] = somemsg[0].somechunkarray[indexmain].vertexlist.ToArray();
                                                                                    somemsg[0].arrayOfTriangles[indexmain] = somemsg[0].somechunkarray[indexmain].triangles.ToArray();
                                                                                    somemsg[0].arrayOfDrawSwitches[indexmain] = 1;

                                                                                    //somemsg[0].arrayOfDrawSwitchesLock[indexmain] = 1;
                        ...
                        if (taskcancelFlagTwo == 4)
                        {
                            ...
                            for (int i = 0; i < total; i++)
                            {
                                if (t0 < total)
                                {
                                    ...
                                    if (someindexmain < total)
                                    {
                                        if (somemsg[0].arrayOfDrawSwitches[someindexmain] == 1)
                                        {
                                            somemsg[0].arrayOfVertices[someindexmain] = somemsg[0].somechunkarray[someindexmain].vertexlist.ToArray();
                                            somemsg[0].arrayOfTriangles[someindexmain] = somemsg[0].somechunkarray[someindexmain].triangles.ToArray();
                                            somemsg[0].arrayOfDrawSwitches[someindexmain] = 2;
                                        }
                                        //= thtrgnrt;
                                    }
                                    else
                ...
                if (indexcreateface < total)
                {
                    ...
                    if (somePooledObject != null)
                    {
                        ...
                        */
                        ...
                        /*blockers[indexcreateface].planetchunk.GetComponent<sccslodchunkfinal>().thechunk = blockers[indexcreateface];

                        blockers[indexcreateface].planetchunk.GetComponent<sccslodchunkfinal>().width = width;
                        blockers[indexcreateface].planetchunk.GetComponent<sccslodchunkfinal>().height = height;
                        blockers[indexcreateface].planetchunk.GetComponent<sccslodchunkfinal>().depth = depth;
                        blockers[indexcreateface].planetchunk.GetComponent<sccslodchunkfinal>().sccslodchunkfinalcustomstart();
                        blockers[indexcreateface].planetchunk.GetComponent<sccslodchunkfinal>().chunkbuildingswtc = 1;
                        */
                    ...
                    if (blockers[indexCreateChunkFaces].map != null)
                    {
                        ...
                        if (blockers[indexCreateChunkFaces].planetchunk != null)
                        {
                            ...
                            else
                            {
                                ...
                                if (_main_received_messages[0].arrayOfDrawSwitches[indexCreateChunkFaces] == 1 && _main_received_messages[0].arrayOfDrawSwitchesLock[indexCreateChunkFaces] == 0)
                                {



                                    //blockers[indexCreateChunkFaces].chunkbuildingswtc = 1;
                                    //blockers[indexCreateChunkFaces].planetchunk.GetComponent<sccslodchunkfinal>().somevertexlist = blockers[indexCreateChunkFaces].vertexlist.ToArray();
                                    //blockers[indexCreateChunkFaces].planetchunk.GetComponent<sccslodchunkfinal>().sometrianglelist = blockers[indexCreateChunkFaces].triangles.ToArray();
                                    //blockers[indexCreateChunkFaces].planetchunk.GetComponent<sccslodchunkfinal>().chunkbuildingswtc = 1;
                                    ...
                                    {
                                        blockers[indexCreateChunkFaces].mesh.Clear();
                                        blockers[indexCreateChunkFaces].mesh.vertices = _main_received_messages[0].arrayOfVertices[indexCreateChunkFaces]; //blockers[indexCreateChunkFaces].vertexlist.ToArray();
                                        blockers[indexCreateChunkFaces].mesh.triangles = _main_received_messages[0].arrayOfTriangles[indexCreateChunkFaces]; //blockers[indexCreateChunkFaces].triangles.ToArray();
                                        blockers[indexCreateChunkFaces].mesh.RecalculateBounds();
                                        blockers[indexCreateChunkFaces].mesh.RecalculateNormals();
                                        //blockers[indexCreateChunkFaces].planetchunk.GetComponent<MeshFilter>().mesh = blockers[indexCreateChunkFaces].mesh;
                                    }
                                    ...
                                    _main_received_messages[0].arrayOfDrawSwitchesLock[indexCreateChunkFaces] = 1;
                                }
                            }
