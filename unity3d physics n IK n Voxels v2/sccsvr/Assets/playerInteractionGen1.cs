...
public class playerInteractionGen1 : MonoBehaviour
{
    ...
    int counterForByteChangeMax = 10;
            ...
            //if (buttonPressedLeft || buttonPressedRight)// Input.GetMouseButton(0))
            {
                //if (Physics.Raycast(ray, out hit))
                {
                    if (collision.transform.tag == "collisionObject")
                    {
                        ...
                        if (planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)collision.transform.position.x, (int)collision.transform.position.y, (int)collision.transform.position.z) != null)
                        {
                            ////Debug.Log("==count==");
                            mainChunkGen1 currentChunk = planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)collision.transform.position.x, (int)collision.transform.position.y, (int)collision.transform.position.z);
                            ...
                            if (collision.contacts[0].normal.x == 0 && collision.contacts[0].normal.y == 0 && collision.contacts[0].normal.z == -1) //FRONT FACE
                            {
                                ...
                                currentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().SetByte((int)indexX, (int)indexY, (int)indexZ, activeBlockType);

                                currentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().Regenerate();
                                currentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().buildMesh();
                    ...
                    if (Physics.Raycast(ray, out hit, 0.1f))
                    {
                        if (hit.transform.tag == "collisionObject")
                        {
                            ...
                            else
                            {
                                ...
                                if (planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)hit.transform.position.x, (int)hit.transform.position.y, (int)hit.transform.position.z) != null)
                                {
                                    ////Debug.Log("==count==");
                                    mainChunkGen1 currentChunk = planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)hit.transform.position.x, (int)hit.transform.position.y, (int)hit.transform.position.z);
                                    ...
                                    if (hit.normal.x == 0 && hit.normal.y == 0 && hit.normal.z == -1) //FRONT FACE
                                    {
                                        ...
                                        //Vector3 retAddPos = new Vector3(x + (planeSize * 0.5f), y + (planeSize * 0.5f), (z + (planeSize * 0.5f)));
                                        Vector3 retAddPos = new Vector3(x, y, z);
                            ...
                            else
                            {
                                ...
                                if (planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)hit.transform.position.x, (int)hit.transform.position.y, (int)hit.transform.position.z) != null)
                                {
                                    ...
                                    if (hit.normal.x == 0 && hit.normal.y == 0 && hit.normal.z == -1) //BACK FACE
                                    {
                                        ...
                                        if (x > 1.0f)
                                        {
                                            indexX = Mathf.RoundToInt((((x - Mathf.Round(x))*chunkWidth) / chunkWidth) * chunkWidth);
                                        }
                                        else
                                        {
                                            indexX = Mathf.RoundToInt((Mathf.Round(x * chunkWidth) / chunkWidth) * chunkWidth);
                                        }
                                        ...
                                        if (y > 1.0f)
                                        {
                                            indexY = Mathf.RoundToInt(((((y - Mathf.Round(y)) * chunkWidth) / chunkWidth) * chunkWidth));
                                        }
                                        else
                                        {
                                            indexY = Mathf.RoundToInt((Mathf.Round(y * chunkWidth) / chunkWidth) * chunkWidth);
                                        }
                                        ...
                                        if (z > 1.0f)
                                        {
                                            indexZ = Mathf.RoundToInt((((z - Mathf.Round(z)) * chunkWidth) / chunkWidth) * chunkWidth);
                                        }
                                        else
                                        {
                                            indexZ = Mathf.RoundToInt((Mathf.Round(z * chunkWidth)/chunkWidth)* chunkWidth);
                                        }
                                        ...
                                        Debug.Log("remainsx: " + (remainsx) + " remainsy: " + (remainsy) + " remainsz: " + (remainsz));
                                        Debug.Log("x: " + (x) + " y: " + (y) + " z: " + (z));
                                        ...
                                        currentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().SetByte((int)indexX, (int)indexY, (int)indexZ, activeBlockType);
                                        //currentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().SetByte((int)x, (int)y, (int)z, activeBlockType);
   ...
   hit.normal.x == 0 && hit.normal.y == -1 && hit.normal.z == 0*/
    public void setAdjacentChunks(mainChunkGen1 currentChunk, Vector3 pos, int indexX, int indexY, int indexZ)
    {
        int width = currentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().width;
        int height = currentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().height;
        int depth = currentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().depth;

        ////Debug.Log("x: " + (indexX) + " y: " + (indexY) + " z: " + (indexZ));

        if (indexX == 0)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)pos.x - 4, (int)pos.y, (int)pos.z) != null)
            {
                mainChunkGen1 adjacentChunk = planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)pos.x - 4, (int)pos.y, (int)pos.z);

                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().GetByte((int)width - 1, (int)indexY, (int)indexZ) == 1)
                {
                    ////Debug.Log("adjacent chunk left exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().SetByte((int)width - 1, (int)indexY, (int)indexZ, 1);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().Regenerate();
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().buildMesh();
                }
            }
        }
        ...
        if (indexX == width - 1)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)pos.x + 4, (int)pos.y, (int)pos.z) != null)
            {
                ...
                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().GetByte((int)0, (int)indexY, (int)indexZ) == 1)
                {
                    ////Debug.Log("adjacent chunk right exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().SetByte((int)0, (int)indexY, (int)indexZ, 1);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().Regenerate();
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().buildMesh();
                }
            }
        ...
        if (indexY == 0)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)pos.x, (int)pos.y - 4, (int)pos.z) != null)
            {
                mainChunkGen1 adjacentChunk = planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)pos.x, (int)pos.y - 4, (int)pos.z);

                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().GetByte((int)indexX, (int)height - 1, (int)indexZ) == 1)
                {
                    ////Debug.Log("adjacent chunk left exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().SetByte((int)indexX, (int)height - 1, (int)indexZ, 1);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().Regenerate();
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().buildMesh();
                }
            }
        ...
        if (indexY == height - 1)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)pos.x, (int)pos.y + 4, (int)pos.z) != null)
            {
                ...
                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().GetByte((int)indexX, (int)0, (int)indexZ) == 1)
                {
                    ////Debug.Log("adjacent chunk left exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().SetByte((int)indexX, (int)0, (int)indexZ, 1);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().Regenerate();
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().buildMesh();
                }
            }
        ...
        if (indexZ == 0)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)pos.x, (int)pos.y, (int)pos.z - 4) != null)
            {
                mainChunkGen1 adjacentChunk = planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)pos.x, (int)pos.y, (int)pos.z - 4);

                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().GetByte((int)indexX, (int)indexY, (int)depth - 1) == 1)
                {
                    ////Debug.Log("adjacent chunk left exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().SetByte((int)indexX, (int)indexY, (int)depth - 1, 1);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().Regenerate();
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().buildMesh();
                }
            }
        ...
        if (indexZ == depth - 1)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)pos.x, (int)pos.y, (int)pos.z + 4) != null)
            {
                ...
                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().GetByte((int)indexX, (int)indexY, (int)0) == 1)
                {
                    ////Debug.Log("adjacent chunk left exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().SetByte((int)indexX, (int)indexY, (int)0, 1);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().Regenerate();
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkGen1>().buildMesh();
                }
            }
...
if (planetmanager.GetComponent<sccsproceduralplanetbuilderGen1>().getChunk((int)hit.transform.position.x, (int)hit.transform.position.y, (int)hit.transform.position.z) != null)
{
    ...
    if (Input.GetMouseButtonDown(0))
    {
        ...
        planetchunk.GetComponent<sccsplanetchunkGen1>().SetByte((int)x, (int)y, (int)z, activeBlockType);

        planetchunk.GetComponent<sccsplanetchunkGen1>().Regenerate();
        planetchunk.GetComponent<sccsplanetchunkGen1>().buildMesh();
