...
namespace SCCoreSystems
{
    ...
    public class Fracture4 : MonoBehaviour
    {
        ...
        public List<GameObject> FracturingObj = new List<GameObject>();
        ...
        void Start()
        {
            ...
            /*if (GetComponent<AudioSource>() != null)
            {
                ...
                {
                    //GetComponent<AudioSource>().set = true;
                }
            ...
            if (tetraHedron.Count == 12)
            {
                ...
                for (int i = 0; i < newTrianglesCount / 4; i++)
                {
                    ...
                    mesh.Clear();
                    FracturingObj[i].transform.name = "bbbulletfragment" + " " + i;
                    fracMesh.name = "bbbulletfragment" + " " + i;
                    FracturingObj[i].transform.tag = "bbbulletfragment";
                    ...
                    FracturingObj[i].transform.gameObject.GetComponent<MeshRenderer>().material = mat;
                    FracturingObj[i].transform.gameObject.GetComponent<MeshFilter>().sharedMesh = fracMesh;

                    Material[] m = new Material[]
                    {
                        mat,//Resources.Load("Materials/FracColor0") as Material,
                        mat,//Resources.Load("Materials/FracColor0") as Material,
                        mat,//Resources.Load("Materials/FracColor0") as Material,
                        mat,//Resources.Load("Materials/FracColor0") as Material,
                    };
                    ...
                    var o_239_17_636177372140594740 = FracturingObj[i].transform.gameObject.GetComponent<MeshFilter>().mesh;
                    ...
                    if (FracturingObj[i].transform.gameObject.GetComponent<BoxCollider>() == null)
                    {
                    ...
                    {
                        FracturingObj[i].gameObject.AddComponent<Rigidbody>().AddExplosionForce(explosionForce, FracturingObj[i].transform.position, (float)sc_maths.getSomeRandNum(0, 9), (float)sc_maths.getSomeRandNum(0, 9));
                    }
                    else
                    {
                        FracturingObj[i].gameObject.GetComponent<Rigidbody>().AddExplosionForce(explosionForce, FracturingObj[i].transform.position, (float)sc_maths.getSomeRandNum(0, 9), (float)sc_maths.getSomeRandNum(0, 9));
                    }
                    ...
                    FracturingObj[i].gameObject.AddComponent<sc_bullet>();
                    FracturingObj[i].gameObject.GetComponent<sc_bullet>().hit_effect = hit_effect;
