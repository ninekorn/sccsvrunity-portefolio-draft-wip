    ...
    public class chunk
    {
        ...
        public threadInfinite.meshData startBuildingArray(Vector3 currentPosition/*,int xx,int yy,int zz/*,bigChunk bigChunk, smallChunk smallChunk*/)
        {
            ...
            if (positions.Length > 0)
            {
                ...
                return new threadInfinite.meshData(currentPosition/*, bigChunk, smallChunk*/, positions.Length,positions,triangleIndices);
            }
            else
            {
                return new threadInfinite.meshData(currentPosition/*, bigChunk = null, smallChunk = null*/, 0, positions,triangleIndices);
            }
        }
