...
namespace SCCoreSystems
{
    ...
    public class sc_perko_voxel : MonoBehaviour
    {
        ...
        public int switchPerlinMountainsNotWorking = 0;
        ...
        private float radiusplanetmountainend = 16;
        ...
        //private List<DVertex> verts = new List<DVertex>();
        ...
        public void buildchunkmap() //, out int vertexNum, out int indicesNum //Vector3 currentPosition, out Vector3[] vertexArray, out int[] indicesArray, 
        {
            ...
            seed = 3420;//(int)Math.Floor(rand.NextDouble() * (_pos.x - 1) + 1);
            ...
            for (int x = -ChunkWidth_L; x <= ChunkWidth_R; x++)
            {
                ...
                for (int y = -ChunkHeight_L; y <= ChunkHeight_R; y++)
                {
                    ...
                    for (int z = -ChunkDepth_L; z <= ChunkDepth_R; z++)
                    {
                        ...
                        /*Transform parentOfThis = transform.parent;
                        Transform parentOfThis2 = parentOfThis.parent;
                        Vector3 position1 = transform.position;

                        float distance1 = Vector3.Distance(position1, parentOfThis.position);
                        ...
                        Vector3 position1 = transform.position;// transform.position;
                        ...
                        if (distance1 >= radiusplanetcorestart && distance1 < radiusplanetmountainend)
                        {
                            ...
                            {
                                if (distance > radiusplanetcrustend && distance < (radiusplanetmountainend - 1))
                                {
                                    //Debug.Log("0");
                                    float temporaryY = 10;
                                    float temporaryZ = 10;
                                    ...
                                    if (_pos.y >= 0 && _pos.x >= 0 && _pos.z >= 0)
                                    {
                                        //Debug.Log("1");
                                        temporaryY *= (Mathf.PerlinNoise((x * planeSize + _pos.x + seed) / detailScale1, (z * planeSize + _pos.z + seed) / detailScale1) * heightScale1);

                                        float size0 = (1 / planeSize) * _pos.y;
                                        temporaryY -= size0;


                                        temporaryX *= (Mathf.PerlinNoise((y * planeSize + _pos.y + seed) / detailScale1, (z * planeSize + _pos.z + seed) / detailScale1) * heightScale1);

                                        float size1 = (1 / planeSize) * _pos.x;
                                        temporaryX -= size1;

                                        temporaryZ *= (Mathf.PerlinNoise((x * planeSize + _pos.x + seed) / detailScale1, (y * planeSize + _pos.y + seed) / detailScale1) * heightScale1);

                                        float size2 = (1 / planeSize) * _pos.z;
                                        temporaryZ -= size2;
                                    ...
                                    else if (_pos.y >= 0 && _pos.x < 0 && _pos.z >= 0)
                                    {
                                        temporaryY *= (Mathf.PerlinNoise((x * planeSize + _pos.x + seed) / detailScale1, (z * planeSize + _pos.z + seed) / detailScale1) * heightScale1);
        ...
        public void Regenerate()
        {
            ...
            Mesh mesh = new Mesh();
            /*Vector3[] vertsPos = new Vector3[tris.Count];
            ...
            mesh.vertices = verts.ToArray();// verts.ToArray();
        ...
        public void DrawBrick(int x, int y, int z, int xi, int yi, int zi) //, int xx, int yy, int zz
        {
            //Debug.Log(map[x,y,z]);
            ...
            else if (x == ChunkWidth_R + 1)
            {
                if (componentParent.getChunk((int)(transform.position.x + 4), (int)(transform.position.y), (int)(transform.position.z)) != null)
                {
                    ...
                    if (chunkdata != null)
                    {
                        var comp = chunkdata.planetchunk.GetComponent<sc_perko_voxel>();

                        if (comp != null)
                        {
                            if (comp.IsTransparent(-ChunkWidth_L + 1, y, z))
                            {
                                offset1 = Vector3.up * planeSize;
                                offset2 = Vector3.forward * planeSize;
                                DrawFace(start + Vector3.right * planeSize, offset1, offset2);
            ...
            else if (x == 0)
            {
                if (componentParent.getChunk((int)(transform.position.x - 4), (int)(transform.position.y), (int)(transform.position.z)) != null)
                {
                    ...
                    if (chunkdata != null)
                    {
                        ...
                        if (comp != null)
                        {
                            if (comp.IsTransparent(ChunkWidth_L + ChunkWidth_R, y, z))
                            {
                                offset1 = Vector3.back * planeSize;
                                offset2 = Vector3.down * planeSize;
                                DrawFace(start + Vector3.up * planeSize + Vector3.forward * planeSize, offset1, offset2);
            ...
            if (z == 0 && componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y), (int)(transform.position.z - 4)) != null)
            {
                ...
                if (chunkdata != null)
                {
                    ...
                    if (comp != null)
                    {
                        if (comp.IsTransparent(x, y, ChunkWidth_L + ChunkWidth_R))
                        {
            ...
            //BACKFACE
            if (z == ChunkDepth_L + ChunkDepth_R && componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y), (int)(transform.position.z + 4)) != null)
            {
                mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y), (int)(transform.position.z + 4));
            ...
            else if (z != ChunkDepth_L + ChunkDepth_R)
            {
                //BACKFACE
                if (IsTransparent(x, y, z + 1))
                {
            ...
            //TOPFACE
            if (y == ChunkHeight_L + ChunkHeight_R && componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y + 4), (int)(transform.position.z)) != null)
            {
            ...
            else if (y != ChunkHeight_L + ChunkHeight_R)
            {
                //TOPFACE
            ...
            if (y == 0 && componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y - 4), (int)(transform.position.z)) != null)
            {
                ...
                if (chunkdata != null)
                {
                    ...
                    if (comp != null)
                    {
                        if (comp.IsTransparent(x, ChunkHeight_L + ChunkHeight_R, z))
                        {
                            offset1 = Vector3.right * planeSize;
                            offset2 = Vector3.forward * planeSize;
            ...
            if (x == 0 && componentParent.getChunk(Mathf.RoundToInt(transform.position.x - 1), Mathf.RoundToInt(transform.position.y), Mathf.RoundToInt(transform.position.z)) != null)
            {
                ...
                if (chunkdata.chunker.GetComponent<sc_perko_voxel>().GetByte(width - 1, y, z) == 0)
                {
                    //LEFTFACE
                    if (IsTransparent(x - 1, y, z))
                    {
            ...
            else if (x == ChunkWidth_R)
            {
                if (componentParent.getChunk((int)(transform.position.x + 4), (int)(transform.position.y), (int)(transform.position.z)) != null)
                {
                    ...
                    if (chunkdata != null)
                    {
                        ...
                        if (comp != null)
                        {
                            if (comp.IsTransparent(-ChunkWidth_L, y, z))
                            {
                                offset1 = Vector3.up * planeSize;
                                offset2 = Vector3.forward * planeSize;
                                DrawFace(start + Vector3.right * planeSize, offset1, offset2);
            ...
            else if (x == -ChunkWidth_L)
            {
                if (componentParent.getChunk((int)(transform.position.x - 4), (int)(transform.position.y), (int)(transform.position.z)) != null)
                {
                    ...
                    if (chunkdata != null)
                    {
                        ...
                        if (comp != null)
                        {
                            if (comp.IsTransparent(ChunkWidth_R, y, z))
                            {
                                offset1 = Vector3.back * planeSize;
                                offset2 = Vector3.down * planeSize;
                                DrawFace(start + Vector3.up * planeSize + Vector3.forward * planeSize, offset1, offset2);
            ...
            else if (z == -ChunkDepth_L && componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y), (int)(transform.position.z - 4)) != null)
            {
                mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y), (int)(transform.position.z - 4));
                ...
                if (chunkdata != null)
                {
                    ...
                    if (comp != null)
                    {
                        if (comp.IsTransparent(x, y, ChunkDepth_R))
                        {
                            offset1 = Vector3.left * planeSize;
                            offset2 = Vector3.up * planeSize;
                            DrawFace(start + Vector3.right * planeSize, offset1, offset2);
            ...
            else if (z == ChunkDepth_R && componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y), (int)(transform.position.z + 4)) != null)
            {
                mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y), (int)(transform.position.z + 4));
                ...
                if (chunkdata != null)
                {
                    ...
                    if (comp != null)
                    {
                        if (comp.IsTransparent(x, y, -ChunkDepth_L))
                        {
                            offset1 = Vector3.right * planeSize;
                            offset2 = Vector3.up * planeSize;
                            DrawFace(start + Vector3.forward * planeSize, offset1, offset2);
            ...
            else if (y == -ChunkHeight_L && componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y + 4), (int)(transform.position.z)) != null)
            {
                mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y + 4), (int)(transform.position.z));
                ...
                if (chunkdata != null)
                {
                    ...
                    if (comp != null)
                    {
                        if (comp.IsTransparent(x, ChunkHeight_R, z))
                        {
                            offset1 = Vector3.forward * planeSize;
                            offset2 = Vector3.right * planeSize;
                            DrawFace(start + Vector3.up * planeSize, offset1, offset2);
            ...
            else if (y == ChunkHeight_R && componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y - 4), (int)(transform.position.z)) != null)
            {
                mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y - 4), (int)(transform.position.z));
                ...
                if (chunkdata != null)
                {
                    ...
                    if (comp != null)
                    {
                        if (comp.IsTransparent(x, -ChunkHeight_L, z))
                        {
                            offset1 = Vector3.right * planeSize;
                            offset2 = Vector3.forward * planeSize;
                            DrawFace(start, offset1, offset2);
