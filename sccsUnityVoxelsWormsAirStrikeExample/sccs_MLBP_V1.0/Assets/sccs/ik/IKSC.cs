...
public class IKSC : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        var dirLowerArmToElbowTarget = handTarget.transform.position - foreArm.transform.position;
        ...
        */
        ...
        //dirLowerArmToElbowTarget.Normalize();
        ...
        //Vector3 ElbowToHand = hand.position - elbowposition;
        //rotation = Quaternion.LookRotation(ElbowToHand, dirLowerArmToElbowTarget);
