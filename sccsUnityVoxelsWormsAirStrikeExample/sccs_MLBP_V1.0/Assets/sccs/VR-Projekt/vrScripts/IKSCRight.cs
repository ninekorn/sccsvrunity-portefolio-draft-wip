...
public class IKSCRight : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        float adjacent = ((targetDistance * targetDistance) - (lengthForeArm * lengthForeArm) + (lengthUpperArm * lengthUpperArm)) / (2 * targetDistance);
