...
public class IKSC : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lengthHand = Vector3.Distance(endForeArm.position, endHand.position);
    ...
    void LateUpdate()
    {
        ...
        //CHARACTER IS SITTING when adding +(lengthHand* lengthHand) to (circircinteradjacentX * circircinteradjacentX)
        //float circircinterhalfA = Mathf.Sqrt((lengthUpperArm * lengthUpperArm) - ((circircinteradjacentX * circircinteradjacentX)+(lengthHand* lengthHand))); 
