...
namespace SCCoreSystems
{
    ...
    //this CreatePlane was found somewhere on the internet. i think it was on unify wiki or unity wiki.
    [ExecuteInEditMode]
    public class CreatePlane : MonoBehaviour //ScriptableWizard
    {
