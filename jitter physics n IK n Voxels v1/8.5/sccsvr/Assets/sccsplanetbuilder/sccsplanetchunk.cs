...
public class sccsplanetchunk : MonoBehaviour
{
    ...
    public void sccsCustomStart(sccsproceduralplanetbuilder sccsproceduralplanetbuilder_)
    {
        ...
        //componentParent = parentObject.gameObject.GetComponent<sccsproceduralplanetbuilder>().currentplanetbuilder;

        componentParent = sccsproceduralplanetbuilder_;// sccsproceduralplanetbuilder.sccsproceduralplanetbuilderstaticscriptlock;
        ...
        if (_block == 1) //|| _block == 2
        {
            ...
            //if (collider.GetComponent<newFloorTiles>().GetByte(_x + chunkWidth - 1, _y, _z) != 1)
            {
                    ...
                    for (int _yy = 0; _yy < _maxHeight; _yy++)
                    {
                        ...
                        if (rowIterateY <= height && rowIterateY >= 0 && rowIterateZ <= depth) // maybe add rowIterateY >= 0
                        {
                            if (_yy == 0 && _zz == 0)
                            {
                                ...
                                oneVertIndexZ = rowIterateZ;
                                ////Instantiate(_sphereVisualOtherColorBlack, new Vector3(_x, rowIterateY + 1, rowIterateZ) * planeSize + chunkPos, Quaternion.identity);
                                foundVertOne = true;
                                ...
                                if (blockExistsInArray(_x, rowIterateY, rowIterateZ + 1))
                                {
                                    ...
                                    if (_block == 0)
                                    {
                                        ...
                                        _maxDepth = _zz;
                                        foundVertThree = true;
                                        ////Instantiate(_sphereVisualOtherColorBlack, new Vector3(_x, rowIterateY + 1, rowIterateZ + 1) * planeSize + chunkPos, Quaternion.identity);
                                    }
                                    else if (_block == 1 || _block == 2)
                                    {
                                ...
                                else
                                {
                                    ...
                                    if (rowIterateZ + 1 == threeVertIndexZ && rowIterateY == twoVertIndexY)
                                    {
                                        ...
                                        ////Instantiate(_sphereVisualOtherColor, new Vector3(threeVertIndexX, rowIterateY, threeVertIndexZ) * planeSize + chunkPos, Quaternion.identity);
                                    }
                                }
                                ...
                                if (blockExistsInArray(_x, rowIterateY - 1, rowIterateZ))
                                {
                                    ...
                                    if (_block == 0)
                                    {
                                        ...
                                        _maxHeight = _yy + 1;
                                        foundVertTwo = true;
                                        ////Instantiate(_sphereVisualOtherColorRed, new Vector3(_x, rowIterateY, rowIterateZ) * planeSize + chunkPos, Quaternion.identity);
                                ...
                                if (blockExistsInArray(_x, rowIterateY - 1, rowIterateZ))
                                {
                                    ...
                                    else if (_block == 1 || _block == 2) //_block == 1||
                                    {
                                        ...
                                        else if (_block == 2)
                                        {
                                            ...
                                            _maxHeight = _yy + 1;
                                            foundVertTwo = true;
                                            ////Instantiate(_sphereVisualOtherColorRed, new Vector3(rowIterateX, rowIterateY, rowIterateZ) * planeSize + chunkPos, Quaternion.identity);
                ...
                */
                ...
                {
                    vertexlist.Add(new Vector3((oneVertIndexX) * planeSize, (oneVertIndexY) * planeSize, (oneVertIndexZ) * planeSize));
                    //////Instantiate(_vertVisual, new Vector3(oneVertIndexX, oneVertIndexY, oneVertIndexZ) * planeSize + chunkPos, Quaternion.identity);
                    _chunkVertexArray[(oneVertIndexX) + vertexlistWidth * ((oneVertIndexY) + vertexlistHeight * (oneVertIndexZ))] = 1;
                    _testVertexArray[(oneVertIndexX) + vertexlistWidth * ((oneVertIndexY) + vertexlistHeight * (oneVertIndexZ))] = _newVertzCounter;
                    _newVertzCounter++;
                }
                ...
                {
                    vertexlist.Add(new Vector3((twoVertIndexX) * planeSize, (twoVertIndexY) * planeSize, (twoVertIndexZ) * planeSize));
                    //////Instantiate(_vertVisual, new Vector3(twoVertIndexX, twoVertIndexY, twoVertIndexZ) * planeSize + chunkPos, Quaternion.identity);
                    _chunkVertexArray[(twoVertIndexX) + vertexlistWidth * ((twoVertIndexY) + vertexlistHeight * (twoVertIndexZ))] = 1;
                    _testVertexArray[(twoVertIndexX) + vertexlistWidth * ((twoVertIndexY) + vertexlistHeight * (twoVertIndexZ))] = _newVertzCounter;
                    _newVertzCounter++;
                }
                ...
                {
                    vertexlist.Add(new Vector3((threeVertIndexX) * planeSize, (threeVertIndexY) * planeSize, (threeVertIndexZ) * planeSize));
                    //////Instantiate(_vertVisual, new Vector3(threeVertIndexX, threeVertIndexY, threeVertIndexZ) *planeSize + chunkPos, Quaternion.identity);
                    _chunkVertexArray[(threeVertIndexX) + vertexlistWidth * ((threeVertIndexY) + vertexlistHeight * (threeVertIndexZ))] = 1;
                    _testVertexArray[(threeVertIndexX) + vertexlistWidth * ((threeVertIndexY) + vertexlistHeight * (threeVertIndexZ))] = _newVertzCounter;
                    _newVertzCounter++;
                }
                ...
                {
                    vertexlist.Add(new Vector3((fourVertIndexX) * planeSize, fourVertIndexY * planeSize, (fourVertIndexZ) * planeSize));
                    //////Instantiate(_vertVisual, new Vector3(fourVertIndexX, fourVertIndexY, fourVertIndexZ) * planeSize + chunkPos, Quaternion.identity);
                    _chunkVertexArray[(fourVertIndexX) + vertexlistWidth * ((fourVertIndexY) + vertexlistHeight * (fourVertIndexZ))] = 1;
                    _testVertexArray[(fourVertIndexX) + vertexlistWidth * ((fourVertIndexY) + vertexlistHeight * (fourVertIndexZ))] = _newVertzCounter;
                    _newVertzCounter++;
                }
                    ...
                    for (int _yy = 0; _yy < _maxHeight; _yy++)
                    {
                        ...
                        if (rowIterateY <= height && rowIterateY >= 0 && rowIterateZ <= depth) // maybe add rowIterateY >= 0
                        {
                            if (_yy == 0 && _zz == 0)
                            {
                                ...
                                oneVertIndexY = rowIterateY + 1;
                                oneVertIndexZ = rowIterateZ;
                                //Instantiate(_sphereVisualOtherColorBlack, new Vector3(_x + 1, rowIterateY + 1, rowIterateZ) * planeSize + chunkPos, Quaternion.identity);
                                foundVertOne = true;
                                ...
                                if (blockExistsInArray(_x, rowIterateY, rowIterateZ + 1))
                                {
                                    ...
                                    if (_block == 0)
                                    {
                                        ...
                                        _maxDepth = _zz;
                                        foundVertThree = true;
                                        //Instantiate(_sphereVisualOtherColorBlack, new Vector3(_x + 1, rowIterateY + 1, rowIterateZ + 1) * planeSize + chunkPos, Quaternion.identity);
                                ...
                                if (blockExistsInArray(_x, rowIterateY - 1, rowIterateZ))
                                {
                                    ...
                                    if (_block == 0)
                                    {
                                        ...
                                        _maxHeight = _yy + 1;
                                        foundVertTwo = true;
                                        //Instantiate(_sphereVisualOtherColorRed, new Vector3(_x + 1, rowIterateY, rowIterateZ) * planeSize + chunkPos, Quaternion.identity);
                            ...
                            else if (_yy > 0 && _zz == 0)
                            {
                                ...
                                if (blockExistsInArray(_x, rowIterateY, rowIterateZ + 1))
                                {
                                    ...
                                    if (_block == 0)
                                    {
                                        ...
                                        _maxDepth = _zz;
                                        foundVertThree = true;
                                        //Instantiate(_sphereVisualOtherColorBlack, new Vector3(_x + 1, rowIterateY + _yy, rowIterateZ + 1) * planeSize + chunkPos, Quaternion.identity);
                    ...
                    for (int _yy = 0; _yy < _maxHeight; _yy++)
                    {
                        ...
                        if (rowIterateY <= height && rowIterateY >= 0 && rowIterateX <= width) // maybe add rowIterateY >= 0
                        {
                            if (_yy == 0 && _xx == 0)
                            {
                                ...
                                oneVertIndexY = rowIterateY + 1;
                                oneVertIndexZ = _z;
                                //Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX, rowIterateY + 1, _z) * planeSize + chunkPos, Quaternion.identity);
                                foundVertOne = true;
                                ...
                                if (blockExistsInArray(rowIterateX + 1, rowIterateY, _z))
                                {
                                    ...
                                    if (_block == 0)
                                    {
                                        ...
                                        _maxWidth = _xx;
                                        foundVertThree = true;
                                        //Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX + 1, rowIterateY + 1, _z) * planeSize + chunkPos, Quaternion.identity);
                                    }
                                    else if (_block == 1 || _block == 2)
                                    {
                                ...
                                if (blockExistsInArray(rowIterateX, rowIterateY - 1, _z))
                                {
                                    ...
                                    if (_block == 0)
                                    {
                                        ...
                                        _maxHeight = _yy + 1;
                                        foundVertTwo = true;
                                        //Instantiate(_sphereVisualOtherColorRed, new Vector3(rowIterateX, rowIterateY, _z) * planeSize + chunkPos, Quaternion.identity);
                                    ...
                                    else if (_block == 1 || _block == 2) //_block == 1||
                                    {
                                        ...
                                        else if (_block == 2)
                                        {
                                            ...
                                            _maxHeight = _yy + 1;
                                            foundVertTwo = true;
                                            //Instantiate(_vertVisual, new Vector3(rowIterateX, rowIterateY, _z) * planeSize + chunkPos, Quaternion.identity);
                            ...
                            else if (_yy == 0 && _xx > 0)
                            {
                                if (blockExistsInArray(rowIterateX + 1, rowIterateY, _z))
                                {
                                    ...
                                    if (_block == 0)
                                    {
                                        ...
                                        _maxWidth = _xx;
                                        foundVertThree = true;
                                        //Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX + 1, rowIterateY + _yy + 1, _z) * planeSize + chunkPos, Quaternion.identity);
                    ...
                    for (int _yy = 0; _yy < _maxHeight; _yy++)
                    {
                        ...
                        if (rowIterateY <= height && rowIterateY >= 0 && rowIterateX <= width) // maybe add rowIterateY >= 0
                        {
                            if (_yy == 0 && _xx == 0)
                            {
                                ...
                                oneVertIndexY = rowIterateY + 1;
                                oneVertIndexZ = _z + 1;
                                //Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX+1, rowIterateY + 1, _z+1) * planeSize + chunkPos, Quaternion.identity);
                                foundVertOne = true;
