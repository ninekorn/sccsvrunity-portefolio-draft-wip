...
public class Fracture4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var someMaterial = gameObject.GetComponent<MeshRenderer>().material;
        ...
        if (tetraHedron.Count == 12)
        {
            ...
            for (int i = 0; i < newTrianglesCount / 4; i++)
            {
                ...
                //to readd if this script breaks as it might be the cause
                ...
                FracturingObj[i].transform.gameObject.GetComponent<MeshRenderer>().material = someMaterial;
                ...
                */
                ...
                FracturingObj[i].GetComponent<Renderer>().materials = m; // m
                ...
                {
                    FracturingObj[i].gameObject.AddComponent<Rigidbody>().AddExplosionForce(explosionForce, FracturingObj[i].transform.position, 1, 1);
                }
        ...
        else
        {
            ...
            for (int i = 0; i < newTrianglesCount / 4; i++)
            {
                ...
                if (FracturingObj[i].transform.gameObject.GetComponent<Rigidbody>() != null)
                {
                    FracturingObj[i].gameObject.GetComponent<Rigidbody>().AddExplosionForce(explosionForce, FracturingObj[i].transform.position, 1, 1);
                }

                FracturingObj[i].gameObject.AddComponent<sccsPhysicsKinematicObject>();
