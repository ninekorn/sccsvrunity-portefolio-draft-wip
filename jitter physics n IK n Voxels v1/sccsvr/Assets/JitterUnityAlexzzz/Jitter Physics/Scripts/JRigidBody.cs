...
{
    public JPhysics.BodyTag bodytag;
    //public Transform sometransform;
    public int rIndex = -1;

    public int drawGizmos = 1;

    [SerializeField] private int rTag = -1;// private bool affectedByGravity = true;
    public int RTag
    {
        get
        {
    ...
    private RigidBody CreateBody()
    {
        ...
        if (JPhysics.currentscript.worldpub.RigidBodies != null)
        {
        ...
        var result = new RigidBody(Shape, material, rIndex, rTag);
        //
    ...
    private void BodyToTransform()
    {
        ...
        Vector3 position = Body.Position.ToVector3();
        ...
        //Vector3 tempPos = position.Value;

        /*if (position.Value != null)
        {
            if (position.Value.x != null && position.Value.y != null && position.Value.z != null)
            {
                tempPos = position.Value;
                if (transform != null)
                {
